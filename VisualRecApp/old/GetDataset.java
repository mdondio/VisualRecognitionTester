...
public class GetDataset extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// XXX capire cosa succede
		// se ho più campi di ritorno rispetto all'oggetto

		// TODO se devo aggiungere roba, es lenght, forse è meglio calcolarla nell'oggetto!
		
		// parser of json
        Gson gson = new Gson();

        //List<Dataset> datasets = db.findByIndex(selector, Dataset.class);
		...
		// se volessi aggiungre
//		datasets.add(new Dataset());

		//----------------------------------------------------------
		// Se non mi va bene il default e lo devo modificare:
//        JsonArray arr = gson.toJsonTree(datasets).getAsJsonArray();
//
//        for(int i = 0; i < arr.size(); i++)
//        {
//        	JsonObject o = arr.get(i).getAsJsonObject();
//	        o.addProperty("extrafield", 12);
